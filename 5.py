...
def rich_disabled_pirates(list_of_pirates):
    return [pirate['Name'] for pirate in list_of_pirates if pirate[
        'has_wooden_leg'] and pirate['gold'] > 15]

# print(rich_disabled_pirates(pirates))
